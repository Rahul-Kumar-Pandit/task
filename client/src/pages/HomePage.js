...
function HomePage() {
  ...
  return (
    <div className="home-page">
      <h1>Product Management</h1>
      <p>
        The backend of this project has been successfully completed and is fully
        functional. The frontend is partially implemented due to the limited
        time provided. Further enhancements can be added as per requirements.
      </p>
      <AddEditProduct
